...
#+DESCRIPTION: Dibujar AsciiArt usando pontencias de 2 y el comando par
#+AUTHOR:      Osiris Alejandro Gomez
#+EMAIL:       osiux@osiux.com
#+LANGUAGE:    es
#+LINK_HOME:   index.html
#+INCLUDE:     header.org
#+KEYWORDS:    Bash, AsciiArt, Terminal
...
[[file:img/draw-with-numbers-in-console.png][file:tmb/draw-with-numbers-in-console.png]]
