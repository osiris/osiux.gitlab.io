...
#+DESCRIPTON:  Reescribir las URLs de cada instancia de gitlab y/o github con el token de acceso en la configuración global de git.
#+AUTHOR:      Osiris Alejandro Gomez
#+EMAIL:       osiux@osiux.com
#+LANGUAGE:    es
#+LINK_HOME:   index.html
#+INCLUDE:     header.org
#+KEYWORDS:    git, token, gitlab, github, codeberg, config, https, ssh
...
#+HTML_HEAD:   <meta property="og:url" content="https://osiux.com/howto-configure-personal-access-tokens-to-git-repositories-using-https.html" />
