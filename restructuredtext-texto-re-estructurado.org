...
#+DESCRIPTION: reStructuredText texto re-estrucuturado
#+AUTHOR:      Osiris Alejandro Gomez
#+EMAIL:       osiux@osiux.com
#+LANGUAGE:    es
#+LINK_HOME:   index.html
#+INCLUDE:     header.org
#+KEYWORDS:    Blog, plaintext, reStructuredText, rst, TextoPlano
#+DATE:        2021-02-06 20:02
#+HTML_HEAD:   <meta property="og:title" content="/reStructuredText/ texto re-estrucuturado" />
#+HTML_HEAD:   <meta property="og:description" content="reStructuredText texto re-estrucuturado" />
...
#+HTML_HEAD:   <meta property="og:image" content="https://osiux.com/img/reStructuredText.png" />
...
http://pub.osiux.com/reStructuredText.txt
