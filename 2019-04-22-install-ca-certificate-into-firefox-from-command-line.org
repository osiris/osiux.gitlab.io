...
#+DESCRIPTION: Instalar una CA en un perfil de Firefox desde la consola
#+AUTHOR:      Osiris Alejandro Gómez
#+EMAIL:       osiux@osiux.com
#+LANGUAGE:    es
#+LINK_HOME:   index.html
#+INCLUDE:     header.org
#+KEYWORDS:    Bash, CA, cert, certutil, consola, firefox, install, Profile, terminal, tty
...
#+HTML_HEAD:   <meta property="og:description" content="Instalar una CA en un perfil de Firefox desde la consola" />
...
#+HTML_HEAD:   <meta property="og:image" content="https://osiux.com/img/install-ca-firefox-profile-certutil.png" />
...
** ChangeLog
  ...
  - [[https://gitlab.com/osiux/osiux.gitlab.io/-/commit/b09a008d8ab9552b6ab0bc6ee7c1aa725cd56c15][=2023-06-22 22:07=]] agregar DESCRIPTION, KEYWORDS y actualizar OpenGraph en /Instalar una CA en un perfil de Firefox desde la consola/
