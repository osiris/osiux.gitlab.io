...
#+DESCRIPTION: Versionar los recursos de AWX en un repositorio git para automatizar la implementación de AWX con GitLab CI/CD y Ansible Tools
#+AUTHOR:      Osiris Alejandro Gomez
#+EMAIL:       osiux@osiux.com
#+LANGUAGE:    es
#+LINK_HOME:   index.html
#+INCLUDE:     header.org
#+KEYWORDS:    Ansible, AWX, git, GitLab, CI, CD, DevOps, AnsibleTools
#+DATE:        2022-10-08 20:17
#+HTML_HEAD:   <meta property="og:title" content="Automatizar la implementación de los recursos de AWX con GitLab CI/CD y Ansible Tools" />
#+HTML_HEAD:   <meta property="og:type" content="article" />
#+HTML_HEAD:   <meta property="og:article:published_time" content="2022-10-08" />
#+HTML_HEAD:   <meta property="og:article:author" content="Osiris Alejandro Gomez" />
#+HTML_HEAD:   <meta property="og:url" content="https://osiux.com/2022-10-08-automate-deployment-of-AWX-resources-with-GitLab-CI-CD-and-ansible-tools.html" />
#+HTML_HEAD:   <meta property="og:site_name" content="OSiUX" />
#+HTML_HEAD:   <meta property="og:locale" content="es_AR" />
#+HTML_HEAD:   <meta property="og:image" content="https://osiux.com/img/ansible-devops-gitlab-awx-deploy-revision.png" />
