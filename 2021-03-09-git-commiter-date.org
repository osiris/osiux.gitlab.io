...
#+DESCRIPTION: Cambiar la fecha de un /commit/ usando =GIT_COMMITER_DATE=
#+AUTHOR:      Osiris Alejandro Gomez
#+EMAIL:       osiux@osiux.com
#+LANGUAGE:    es
#+LINK_HOME:   index.html
#+INCLUDE:     header.org
#+KEYWORDS:    Git, Commit, Committer, Date, TimeMachine
#+DATE:        2021-03-09 23:20
#+HTML_HEAD:   <meta property="og:title" content="cambiar la fecha de un /commit/ usando =GIT_COMMITER_DATE=" />
#+HTML_HEAD:   <meta property="og:description" content="Cambiar la fecha de un /commit/ usando =GIT_COMMITER_DATE=" />
...
#+HTML_HEAD:   <meta property="og:image" content="https://osiux.com/img/git-committer-date.png" />

[[file:img/git-committer-date.png][file:tmb/git-committer-date.png]]
...
** ChangeLog
  ...
  - [[https://gitlab.com/osiux/osiux.gitlab.io/-/commit/556cc164431468258259fe8d6c852d939287d6b9][=2023-06-01 22:24=]] agregar DESCRIPTION, KEYWORDS, imagen y actualizar tags OpenGraph en cambiar la fecha de un /commit/ usando =GIT_COMMITER_DATE=
