...
#+DESCRIPTION: Realizar un progile en vim para detectar que función es lenta al resaltar sintaxis de Markdown
#+AUTHOR:      Osiris Alejandro Gómez
#+EMAIL:       osiux@osiux.com
#+LANGUAGE:    es
#+LINK_HOME:   index.html
#+INCLUDE:     header.org
#+KEYWORDS:    Vim, Profile, Debug, Markdown
...
#+HTML_HEAD:   <meta property="og:description" content="Realizar un progile en vim para detectar que función es lenta al resaltar sintaxis de Markdown" />
...
#+HTML_HEAD:   <meta property="og:image" content="https://osiux.com/img/vim-profile-markdown.png" />

[[file:img/vim-profile-markdown.png][file:tmb/vim-profile-markdown.png]]
