...
#+DESCRIPTION: Music On Console o cómo configurar tmux, mocp, pulsemixer y cava
#+AUTHOR:      Osiris Alejandro Gomez
#+EMAIL:       osiux@osiux.com
#+LANGUAGE:    es
#+LINK_HOME:   index.html
#+INCLUDE:     header.org
#+KEYWORDS:    Blog, cava, consola, mocp, music, PulseAudio, pulsemixer, terminal, tmux, tty
#+DATE:        2021-02-14 11:27
#+HTML_HEAD:   <meta property="og:title" content="=tty= /Music On Console/" />
#+HTML_HEAD:   <meta property="og:description" content="Music On Console o cómo configurar tmux, mocp, pulsemixer y cava" />
...
** ChangeLog
  ...
  - [[https://gitlab.com/osiux/osiux.gitlab.io/-/commit/dce8a1b754ee86eb0c15b3319684463db71a5a3c][=2023-07-13 22:58=]] agregar DESCRIPTION, KEYWORDS y actualizar OpenGraph en /Music On Console/
