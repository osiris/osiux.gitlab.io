...
#+DESCRIPTION: Descargar libros, cuentos y revistas del dominio público y materiales liberados usando Letras Viajeras
#+AUTHOR:      Osiris Alejandro Gomez
#+EMAIL:       osiux@osiux.com
#+LANGUAGE:    es
#+LINK_HOME:   index.html
#+INCLUDE:     header.org
#+KEYWORDS:    Blog, WiFi, OpenWRT, Flask, Boostrap, CompartirEsBueno
...
#+HTML_HEAD:   <meta property="og:description" content="Descargar libros, cuentos y revistas del dominio público y materiales liberados usando Flask y OpenWRT" />
...
[fn:boostrap]  https://getbootstrap.com/
[fn:flask]     https://flask.palletsprojects.com/
...
** ChangeLog
  ...
  - [[https://gitlab.com/osiux/osiux.gitlab.io/-/commit/016205bd39be77bd8a40aa30c441492edb21b774][=2023-07-01 00:55=]] agregar DESCRIPTION, KEYWORDS, actualizar OpenGraph y footnotes
