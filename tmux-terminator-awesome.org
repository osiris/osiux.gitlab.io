...
#+DESCRIPTION: Entorno de trabajo ágil usando tmux, terminator y awesome
#+AUTHOR:      Osiris Alejandro Gómez
#+EMAIL:       osiux@osiux.com
#+LANGUAGE:    es
#+LINK_HOME:   index.html
#+INCLUDE:     header.org
#+KEYWORDS:    Blog, AwesomeWM, screen, terminator, tmux, workspace
#+DATE:        2015-01-22 05:08
#+HTML_HEAD:   <meta property="og:title" content="tmux + terminator + awesome" />
#+HTML_HEAD:   <meta property="og:description" content="tmux + terminator + awesome" />
#+HTML_HEAD:   <meta property="og:type" content="article" />
#+HTML_HEAD:   <meta property="og:article:published_time" content="2015-01-22" />
#+HTML_HEAD:   <meta property="og:article:author" content="Osiris Alejandro Gómez" />
#+HTML_HEAD:   <meta property="og:url" content="https://osiux.com/tmux-terminator-awesome.html" />
#+HTML_HEAD:   <meta property="og:site_name" content="OSiUX" />
#+HTML_HEAD:   <meta property="og:locale" content="es_AR" />
#+HTML_HEAD:   <meta property="og:image" content="https://osiux.com/img/tmux-terminator-awesome.png" />
...
** =tmux= es un excelente monitor
   ...
   /script/ =tmux= es muy simple ver que esta sucediendo en cada
   interfaz de red al mismo tiempo:
