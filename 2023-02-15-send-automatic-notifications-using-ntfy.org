...
#+INCLUDE:     header.org
#+KEYWORDS:    Automation, Bash, Curl, Notify
...
[[file:img/ntfy/ntfy-all.png][file:tmb/ntfy/ntfy-all.png]]
...
[[file:img/ntfy/ntfy-ipinfo.png][file:tmb/ntfy/ntfy-ipinfo.png]]
...
[[file:img/ntfy/ntfy-mountpoint.png][file:tmb/ntfy/ntfy-mountpoint.png]]

*** =ntfy-uptime.sh=

Notifica la salida de =uptime= si se produce un reinicio.

[[file:img/ntfy/ntfy-uptime.png][file:tmb/ntfy/ntfy-uptime.png]]
...
** ChangeLog
  ...
  - [[https://gitlab.com/osiux/osiux.gitlab.io/-/commit/3b6f6d3c71a109bd306e7b724322abd109333b44][=2023-02-16 13:30=]] corregir links de previews de imágenes de /enviar notificaciones automáticas usando =ntfy.sh=/
  - [[https://gitlab.com/osiux/osiux.gitlab.io/-/commit/5a50fa13e7bb99411251cc48b57745b0b147d482][=2023-02-16 12:46=]] actualizar imágenes de /enviar notificaciones automáticas usando =ntfy.sh=/
