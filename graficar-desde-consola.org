...
#+DESCRIPTION: Graficar desde consola en ASCII/UTF8 Art y usando ditaa, gnuplot, graphviz, nwdiag y plantuml
#+AUTHOR:      Osiris Alejandro Gómez
#+EMAIL:       osiux@osiux.com
#+LANGUAGE:    es
#+LINK_HOME:   index.html
#+INCLUDE:     header.org
#+KEYWORDS:    Blog, ASCIIArt, Consola, Desing, ditaa, gnuplot, Graph, graphviz, Networks, nwdiag, plantuml, Terminal, UML, UTF8Art, Viz
#+DATE:        2014-03-11 10:35
#+HTML_HEAD:   <meta property="og:title" content="Graficar desde consola" />
#+HTML_HEAD:   <meta property="og:description" content="Graficar desde consola en ASCII/UTF8 Art y usando ditaa, gnuplot, graphviz, nwdiag y plantuml" />
#+HTML_HEAD:   <meta property="og:type" content="article" />
#+HTML_HEAD:   <meta property="og:article:published_time" content="2014-03-11" />
#+HTML_HEAD:   <meta property="og:article:author" content="Osiris Alejandro Gómez" />
#+HTML_HEAD:   <meta property="og:url" content="https://osiux.com/graficar-desde-consola.html" />
#+HTML_HEAD:   <meta property="og:site_name" content="OSiUX" />
#+HTML_HEAD:   <meta property="og:locale" content="es_AR" />
#+HTML_HEAD:   <meta property="og:image" content="https://osiux.com/img/BuenosAiresLibre-CompartirEsBueno-LibreVPN-LibreNet6.png" />
...
** block-diag
   ...
   [[file:img/BuenosAiresLibre-CompartirEsBueno-LibreVPN-LibreNet6.png][file:tmb/BuenosAiresLibre-CompartirEsBueno-LibreVPN-LibreNet6.png]]
...
*** desde un archivo de datos
    ...
    #+BEGIN_SRC gnuplot :var data='~/data/bcc/gca/asterisk/asterisk1-bean-query-20.dat' :file img/asterisk1-bean-query-20.png :exports code
      load '~/bin/osiux.plt'
      set lmargin 10
      set rmargin 10
      set bmargin 10
    ...
    [[file:img/asterisk1-bean-query-20.png][file:tmb/asterisk1-bean-query-20.png]]
...
*** procesar un log, generar el archivo y graficar
    ...
    #+BEGIN_SRC gnuplot :var data='~/blog/0895-query-execution-time.dat' :file img/0895-query-execution-time.png :exports code
      load '~/bin/osiux.plt'
      set lmargin 10
      set bmargin 10
      set rmargin 10
    ...
    [[file:img/0895-query-execution-time.png][file:tmb/0895-query-execution-time.png]]
