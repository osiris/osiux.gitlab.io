...
#+DESCRIPTION: Cómo usar GitLab desde la línea de comandos con gitlab-bash-utils
#+AUTHOR:      Osiris Alejandro Gomez
#+EMAIL:       osiux@osiux.com
#+LANGUAGE:    es
#+LINK_HOME:   index.html
#+INCLUDE:     header.org
#+KEYWORDS:    Git, Alias, Bash, CommandLine, Consola, GitLab, Issues, Journal, jrnl, Merge, tty, Utils
#+DATE:        2022-08-21 19:49
#+HTML_HEAD:   <meta property="og:title" content="" />
#+HTML_HEAD:   <meta property="og:description" content="Cómo usar GitLab desde la línea de comandos con gitlab-bash-utils" />
#+HTML_HEAD:   <meta property="og:type" content="article" />
#+HTML_HEAD:   <meta property="og:article:published_time" content="" />
#+HTML_HEAD:   <meta property="og:article:author" content="" />
#+HTML_HEAD:   <meta property="og:url" content="https://osiux.com/2022-08-21-howto-use-gitlab-from-command-line.html" />
#+HTML_HEAD:   <meta property="og:site_name" content="OSiUX" />
#+HTML_HEAD:   <meta property="og:locale" content="es_AR" />
#+HTML_HEAD:   <meta property="og:image" content="https://osiux.com/img/gitlab-bash-utils.jpg" />
#+HTML_HEAD:   <meta property="og:video" content="https://osiux.com/cómo" />
...
** ChangeLog
  ...
  - [[https://gitlab.com/osiux/osiux.gitlab.io/-/commit/83c539767da572a2f62c2a127b8b8a0f05f7a5e4][=2023-06-26 22:03=]] agregar DESCRIPTION, KEYWORDS y actualizar OpenGraph en /Cómo usar GitLab desde la línea de comandos/
  ...
  - [[https://gitlab.com/osiux/osiux.gitlab.io/-/commit/0b200766813009e7d95a63f31e8e48930d7baae4][=2022-10-11 10:05=]] agregar cómo usar /GitLab/ desde la línea de comandos
