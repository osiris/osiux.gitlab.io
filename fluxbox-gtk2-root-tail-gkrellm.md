...
[`.org`](https://gitlab.com/osiux/osiux.gitlab.io/-/raw/master/fluxbox-gtk2-root-tail-gkrellm.org) |
[`.md`](https://gitlab.com/osiux/osiux.gitlab.io/-/raw/master/fluxbox-gtk2-root-tail-gkrellm.md) |
[`.gmi`](gemini://gmi.osiux.com/fluxbox-gtk2-root-tail-gkrellm.gmi) |
[`.html`](https://osiux.gitlab.io/fluxbox-gtk2-root-tail-gkrellm.html)

Decidí salir de gnome y probar **fluxbox**, el resultado: no vuelvo ni
por Beryl (aunque lo extraño!). Realmente es muy facil personalizarlo y
como manejador de ventanas es excelente, muy rapido y practicamente no
consume recursos

[![](https://osiux.com/tmb/osiux-fluxbox-screenshot-640x480-01.png)](https://osiux.com/img/osiux-fluxbox-screenshot-1024x768-01.png)

## Editar un style

Inicialmente descargue unos cuantos y termine modificandolos y haciendo
un mix entre Sephiroth y Equilibrium.
...
`~/.fluxbox/styles/osiux/theme.cfg` donde osiux es el nombre del tema.
...
La llamada al script debe hacerce en el archivo `~/.fluxbox/init` en la
siguiente linea:
...
`gnome-settings-daemon` y el mismo se agrega en el archivo
`~/.fluxbox/startup` antes de que se ejecute fluxbox:
...
Esta utilidad es similar al tail y permite convertir un log a una imagen
en el desktop, es posible definir colores, fuente y posicion de la
imagen, es excelente!. Asi que solo es necesario crearse un par de
...
permiten desde ver la temperatura de su ciudad como manejar el xmms o
