...
#+DESCRIPTION: Cómo lograr un elegante documento desde una oscura terminal usando LaTeX Beamer y Org-mode
#+AUTHOR:      Osiris Alejandro Gomez
#+EMAIL:       osiux@osiux.com
#+DATE:        2012-02-14 05:38
#+KEYWORDS:    Blog, Beamer, Consola, Emacs, LaTeX, Org, org2pdf, Org-mode, PDF, Shell, Talk, Terminal, tty
#+INCLUDE:     header.org
#+HTML_HEAD:   <meta property="og:title" content="de fondo negro a fondo blanco" />
#+HTML_HEAD:   <meta property="og:description" content="Cómo lograr un elegante documento desde una oscura terminal usando LaTeX Beamer y Org-mode" />
...
#+HTML_HEAD:   <meta property="og:url" content="https://osiux.com/de-fondo-negro-a-fondo-blanco.html" />
