...
#+DESCRIPTION: prose.sh es una plataforma de blog pensada para hackers, es minimalista y esta basada en SSH y Markdown
#+AUTHOR:      Osiris Alejandro Gomez
#+EMAIL:       osiux@osiux.com
#+LANGUAGE:    es
#+LINK_HOME:   index.html
#+INCLUDE:     header.org
#+KEYWORDS:    Blog, Markdown, Hackers, SSH
...
[[file:img/osiux-prose-sh-blog-ssh-markdown.png][file:tmb/osiux-prose-sh-blog-ssh-markdown.png]]
