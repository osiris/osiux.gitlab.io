...
Buscando automatizar la publicación de mi blog, descubrí la opción de utilizar *gitlab pages* junto con *gitlab CI*, posibilitando un rápido y des-atendido deploy.
...
#+BEGIN_SRC: emacs-lisp :results ouput :exports code
